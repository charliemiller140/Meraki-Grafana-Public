...
**Comprehensive network analytics using the Meraki Dashboard API, InfluxDB, and Grafana deployed and orchestrated with Ansible, Terraform, and GitHub Actions. The point of this was to collect and store data that goes beyond the Meraki dashboard, and allow greater trend monitoring to aid troubleshooting.**
